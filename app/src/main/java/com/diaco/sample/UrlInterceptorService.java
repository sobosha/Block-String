...
public class UrlInterceptorService extends AccessibilityService {
    ...
    protected void onServiceConnected() {
        Log.d("Accessbility","Service conected");
    ...
    public void onAccessibilityEvent(@NonNull AccessibilityEvent event) {
        Log.d("Accessbility","Service Event");
        ...
        //Toast.makeText(this,capturedUrl+ "salam", Toast.LENGTH_SHORT).show();
        if(capturedUrl!=null) {
            if (capturedUrl.contains("salam.ir")) {
